...
public class AuditTextViewModel extends TextViewModel {
    ...
    public List<TextCard> fetchFromNetwork(ListFragmentBase videoListFragment) throws IOException {
        ...
        if (AuditFragment.TYPE_AVATAR.equals(frag.type)){
            var result1 = MyApp.getInstance().getOttohubApi().getProfileApi().audit_avatar_list(12 * frag.currentPage, 12);
            ...
            var result1 = MyApp.getInstance().getOttohubApi().getProfileApi().audit_cover_list(12 * frag.currentPage, 12);
            ApiUtil.throwApiError(result1);
            ...
            var result1 = MyApp.getInstance().getOttohubApi().getVideoApi().audit_video_list(12 * frag.currentPage, 12);
            ApiUtil.throwApiError(result1);
            ...
            var result1 = MyApp.getInstance().getOttohubApi().getBlogApi().audit_blog_list(12 * frag.currentPage, 12);
            ApiUtil.throwApiError(result1);
